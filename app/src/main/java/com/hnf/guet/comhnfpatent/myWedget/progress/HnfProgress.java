package com.hnf.guet.comhnfpatent.myWedget.progress;
...
public class HnfProgress {

    private static final String TAG = "HnfProgress";
    ...
    public HnfProgress(Context context, DialogInterface.OnKeyListener listener) {
        mContext = context;
    ...
    public static HnfProgress create(Context context, DialogInterface.OnKeyListener mOnKeyListener) {
        return new HnfProgress(context, mOnKeyListener);
    }


    public HnfProgress setStyle(Style style) {
        View view = null;
        switch (style) {
